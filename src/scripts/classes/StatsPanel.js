export default class StatsPanel {
    ...
    create() {
        ...
        this.lapText = this.scene.add.text(10, 30, `Lap: ${this.stats.currentLap}/${this.stats.laps}`, style).setScrollFactor(0);
    ...
    render() {
        this.lapText.setText(`Lap: ${this.stats.currentLap}/${this.stats.laps}`);
